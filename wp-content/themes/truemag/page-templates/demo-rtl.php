<?php 
/*
 * Template Name: Demo RTL
 */
function rtl_scripts_styles() {
	global $wp_styles;
	wp_enqueue_style( 'rtl', get_template_directory_uri() . '/css/rtl.css');
}
add_action( 'wp_enqueue_scripts', 'rtl_scripts_styles' );
...
?>
	<?php tm_display_ads('ad_top_1');?>
		...
		?>
        <div id="top-nav" class="<?php echo $topnav_style=='light'?'topnav-light light-div':'topnav-dark'; echo ' '.$topnav_layout; ?>">
